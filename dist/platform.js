 ...
 */
exports.PLUGIN_NAME = 'homebridge-elyeu-shelly-gui1';
/**
 ...
 */
class ConfigDeviceDiscoverer extends homebridge_elyeu_shelly_node_gui1_1.DeviceDiscoverer {
    /**
 ...
 */
class CacheDeviceDiscoverer extends homebridge_elyeu_shelly_node_gui1_1.DeviceDiscoverer {
    /**
...
class ShellyPlatform {
    ...
    constructor(log, config, api) {
        ...
        // setup homebridge-elyeu-shelly-node-gui1
        this.shellies = new homebridge_elyeu_shelly_node_gui1_1.Shellies({
            websocket: { ...this.options.websocket, clientId: 'homebridge-elyeu-shelly-gui1-' + Math.round(Math.random() * 1000000) },
            autoLoadStatus: true,
            autoLoadConfig: true,
    ...
    async startMdnsDeviceDiscovery() {
        // create a device discoverer
        const discoverer = new homebridge_elyeu_shelly_node_gui1_1.MdnsDeviceDiscoverer(this.options.mdns);
        // register it
        this.shellies.registerDiscoverer(discoverer);
        // log errors
    ...
    /**
     * Handles 'add' events from the homebridge-elyeu-shelly-node-gui1 library.
     */
    ...
    /**
     * Handles 'remove' events from the homebridge-elyeu-shelly-node-gui1 library.
     */
    ...
    /**
     * Handles 'exclude' events from the homebridge-elyeu-shelly-node-gui1 library.
     */
    ...
    /**
     * Handles 'unknown' events from the homebridge-elyeu-shelly-node-gui1 library.
     */
    handleUnknownDevice(deviceId, model) {
        this.log.info(`[${deviceId}] Unknown device of model "${model}" discovered.`);
    }
    /**
     * Handles 'error' events from the homebridge-elyeu-shelly-node-gui1 library.
     */
