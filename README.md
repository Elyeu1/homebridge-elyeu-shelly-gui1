<a href="https://github.com/alexryd/homebridge-elyeu-shelly-gui1"><img src="homebridge-elyeu-shelly-gui1.png" height="120"></a>

# homebridge-elyeu-shelly-gui1
[![npm-version](https://badgen.net/npm/v/homebridge-elyeu-shelly-gui1)](https://www.npmjs.com/package/homebridge-elyeu-shelly-gui1)
...
2. Install this plugin by running `npm install -g homebridge-elyeu-shelly-gui1`.
...
| `devices. id`                   | The device ID. [Here's how to find it](https://github.com/alexryd/homebridge-elyeu-shelly-gui1/wiki/Finding-a-device-ID). |
